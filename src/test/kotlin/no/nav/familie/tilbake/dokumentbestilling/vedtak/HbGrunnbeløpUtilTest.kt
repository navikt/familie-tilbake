...
internal class HbGrunnbeløpUtilTest {
    ...
    internal fun `skal bruke fra og til fra perioden hvis de er innenfor perioden sine datoer `() {
        val result = lagHbGrunnbeløp(Datoperiode(YearMonth.of(2021, 3), YearMonth.of(2021, 3)))
    ...
    internal fun `skal bruke periode sin fom hvis den er større enn beløpsperiode sin startdato`() {
        val result = lagHbGrunnbeløp(Datoperiode(YearMonth.of(2021, 3), YearMonth.of(2021, 6)))
    ...
    internal fun `skal bruke periode sin fom hvis den er større enn beløpsperiode sin startdato 2`() {
        val result = lagHbGrunnbeløp(Datoperiode(YearMonth.of(2021, 4), YearMonth.of(2021, 5))).tekst6GangerGrunnbeløp
    ...
    internal fun `periode og beløpsperiode er lik - gir kun en periode`() {
        val result = lagHbGrunnbeløp(Datoperiode(YearMonth.of(2021, 5), YearMonth.of(2022, 4)))
    ...
    internal fun `perioden går over 3 grunnbeløpsperioder`() {
        val result = lagHbGrunnbeløp(Datoperiode(YearMonth.of(2021, 3), YearMonth.of(2022, 6))).tekst6GangerGrunnbeløp
