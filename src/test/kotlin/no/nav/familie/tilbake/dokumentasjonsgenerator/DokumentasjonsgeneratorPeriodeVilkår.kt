...
class DokumentasjonsgeneratorPeriodeVilkår {
        ...
        vilkårResultat.forEach { resultat ->
            aktsomheter.forEach { vurdering ->
                foreldelseVurderinger.forEach { foreldelseVurdering ->
                    lagResultatOgVurderingTekster(ytelsetype,
                                                  språkkode,
                                                  resultat,
                                                  vurdering,
                                                  foreldelseVurdering,
    ...
    private fun lagResultatOgVurderingTekster(ytelsetype: Ytelsestype,
                                              språkkode: Språkkode,
                                              ...
                                              lavtBeløp: Boolean) {
        val periodeOgFelles = lagPeriodeOgFelles(ytelsetype,
                                                 språkkode,
                                                 resultat,
                                                 vurdering,
                                                 lavtBeløp,
    ...
    private fun lagPeriodeOgFelles(ytelsetype: Ytelsestype,
                                   ...
                                   foreldelsevurdering: Foreldelsesvurderingstype,
                                   fritekst: Boolean,
                                   pengerIBehold: Boolean): HbVedtaksbrevPeriodeOgFelles {
        ...
        val vurderinger =
                HbVurderinger(foreldelsevurdering = foreldelsevurdering,
                              ...
                              foreldelsesfrist = if (foreldelsevurdering in setOf(Foreldelsesvurderingstype.FORELDET,
        ...
        val periodeBuilder =
                HbVedtaksbrevsperiode(periode = JANUAR,
                                      resultat = HbResultat(tilbakekrevesBeløp = BigDecimal.valueOf(9999),
    ...
    private fun lagFelles(ytelsestype: Ytelsestype,
                          språkkode: Språkkode): HbVedtaksbrevFelles {
        val datoer = HbVedtaksbrevDatoer(LocalDate.of(2018, 3, 2),
                                         LocalDate.of(2018, 3, 3),
                                         LocalDate.of(2018, 3, 4))

        return HbVedtaksbrevFelles(brevmetadata = lagMetadata(ytelsestype, språkkode),
                                   ...
                                   konfigurasjon = HbKonfigurasjon(fireRettsgebyr = BigDecimal.valueOf(4321),
                                                                   klagefristIUker = 4,
    ...
    companion object {
        ...
        private val vilkårResultat = arrayOf(Vilkårsvurderingsresultat.FORSTO_BURDE_FORSTÅTT,
                                             Vilkårsvurderingsresultat.MANGELFULLE_OPPLYSNINGER_FRA_BRUKER,
                                             Vilkårsvurderingsresultat.FEIL_OPPLYSNINGER_FRA_BRUKER)
        private val foreldelseVurderinger = arrayOf(Foreldelsesvurderingstype.IKKE_VURDERT,
                                                    Foreldelsesvurderingstype.IKKE_FORELDET,
                                                    Foreldelsesvurderingstype.TILLEGGSFRIST)
        private val aktsomheter = arrayOf(Aktsomhet.SIMPEL_UAKTSOMHET,
