...
/*
    val defaultBrevmottakerRef = field(
        "default_brevmottaker_ref",
        { it.defaultMottakerEntity.id },
        FieldConverter.UUIDConverter.required(),
    )

    val registrertBrevmottakerRef = field(
        "registrert_brevmottaker_ref",
        { it.registrertBrevmottakerEntity.id },
        FieldConverter.UUIDConverter.required(),
    )
 */
    ...
    object RegistrertBrevmottaker : Entity<RegistrertBrevmottakerEntity, UUID, UUID>(
        ...
        fun map(
            ...
            return RegistrertBrevmottakerEntity(
                ...
                manuellAdresseInfoEntity = if (resultSet[adresselinje1] != null) {
                ...
                defaultMottaker = defaultMottakerEntity,
