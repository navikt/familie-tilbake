...
class DokarkivClientImpl(
    ...
    override fun journalførVarselbrev(
        ...
        val request = OpprettJournalpostRequest(
            ...
            journalfoerendeEnhet = "1234", // requireNotNull(varselbrevBehov.behandlendeEnhet) { "Enhetskode kreves for journalføring" }.kode,
            sak = Sak(
    ...
    private fun hentBrevMetadata(varselbrevBehov: VarselbrevBehov): Brevmetadata {
        return Brevmetadata(
            ...
            behandlendeEnhetsNavn = "test", // requireNotNull(varselbrevBehov.behandlendeEnhet) { "Enhetsnavn kreves for journalføring" }.navn,
            ansvarligSaksbehandler = "saksbehandler", // requireNotNull(varselbrevBehov.varselbrev.ansvarligSaksbehandlerIdent) { "ansvarligSaksbehandlerIdent kreves for journalføring" },
