    ...
    private suspend fun hentOrganisasjonNøkkelinfo(orgnr: String): HentOrganisasjonResponse {
        ...
        try {
            ...
            if (response.status.isSuccess()) {
                return response.body<HentOrganisasjonResponse>()
            } else {
            ...
            throw Feil(
                message = "Henting av organisasjoninfo feilet: ${e.message}",
                frontendFeilmelding = "Henting av organisasjoninfo feilet",
                logContext = logContext,
            )
        }
    }
