...
class SaksbehandlerService(
    ...
    fun hentSaksbehandler(
        ...
        val azureAdBruker = entraProxyClient.hentSaksbehandler(
            id,
        )

        return Saksbehandler(
            navIdent = azureAdBruker.navIdent,
            fornavn = azureAdBruker.fornavn,
            etternavn = azureAdBruker.etternavn,
            enhet = azureAdBruker.enhet.enhetnummer,
            enhetsnavn = azureAdBruker.enhet.navn,
        )
    }
