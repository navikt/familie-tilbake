...
class Vedleggsdata(override val språkkode: Språkkode,
                   @Suppress("unused") // Handlebars
                   val ytelseMedSkatt: Boolean,
                   val feilutbetaltePerioder: List<FeilutbetaltPeriode>) : Språkstøtte

data class FeilutbetaltPeriode(val måned: YearMonth,
