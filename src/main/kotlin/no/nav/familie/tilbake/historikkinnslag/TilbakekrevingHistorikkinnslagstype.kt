...
enum class TilbakekrevingHistorikkinnslagstype(val tittel: String,
    ...
    BEHANDLING_HENLAGT(tittel = "Behandling henlagt"),

    // Skjermlenke type
    FAKTA_VURDERT(tittel = "Fakta vurdet",
                  type = Historikkinnslagstype.SKJERMLENKE,
                  steg = Behandlingssteg.FAKTA),
    FORELDELSE_VURDERT(tittel = "Foreldelse vurdet",
                       type = Historikkinnslagstype.SKJERMLENKE,
                       steg = Behandlingssteg.FORELDELSE),
    VILKÅRSVURDERING_VURDERT(tittel = "Vilkår vurdet",
                             type = Historikkinnslagstype.SKJERMLENKE,
