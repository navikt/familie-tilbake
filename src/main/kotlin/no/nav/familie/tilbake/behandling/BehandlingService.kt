    ...
    fun opprettBehandlingManuellTask(opprettManueltTilbakekrevingRequest: OpprettManueltTilbakekrevingRequest) {
        ...
        if (!kanBehandlingOpprettesManuelt.kanBehandlingOpprettes) {
            throw Feil(
                ...
                logContext = SecureLog.Context.utenBehandling(opprettManueltTilbakekrevingRequest.eksternFagsakId),
            )
        }
        ...
        val properties =
            Properties().apply {
                ...
                setProperty("ansvarligSaksbehandler", ContextService.hentSaksbehandler(SecureLog.Context.utenBehandling(opprettManueltTilbakekrevingRequest.eksternFagsakId)))
            }
        taskService.save(
            Task(
