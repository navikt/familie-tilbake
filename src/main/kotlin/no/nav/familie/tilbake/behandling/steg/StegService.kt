...
class StegService(
    ...
    fun håndterSteg(
        ...
        behandlingskontrollService.behandleStegPåNytt(behandlingId, logContext, behandledeSteg)
        hentStegInstans(behandledeSteg).utførSteg(behandlingId, behandlingsstegDto, logContext)
    ...
    fun angreSendTilBeslutter(
        ...
        behandlingskontrollService.behandleStegPåNytt(behandling.id, logContext, Behandlingssteg.FORESLÅ_VEDTAK)
    }
