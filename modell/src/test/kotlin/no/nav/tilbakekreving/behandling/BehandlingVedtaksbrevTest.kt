...
import no.nav.tilbakekreving.DefaultModellTestdataProvider.forårsaketAvBruker
import no.nav.tilbakekreving.DefaultModellTestdataProvider.forårsaketAvNav
import no.nav.tilbakekreving.DefaultModellTestdataProvider.skalIkkeUnnlates
import no.nav.tilbakekreving.DefaultModellTestdataProvider.skalUnnlates
        ...
        fun vurderinger(): List<Arguments> {
            return listOf(
                Arguments.argumentSet(
                    ...
                    forårsaketAvNav().godTro {
                        beløpIBehold = 1400.kroner
                    },
