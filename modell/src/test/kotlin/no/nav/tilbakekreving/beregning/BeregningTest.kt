...
class BeregningTest {
    ...
    fun `ny vilkårsvurdering, hele beløpet i behold, med reduksjon`() {
        val beregning = Beregning(
            ...
            foreldetPerioder = emptyList(),
            kravgrunnlag = perioder(
                1.januar(2021) til 31.januar(2021) medTilbakekrevesBeløp 2500.kroner,
                1.februar(2021) til 28.februar(2021) medTilbakekrevesBeløp 1500.kroner,
            ),
            sporing = Sporing(UUID.randomUUID().toString(), UUID.randomUUID().toString()),
        )
        ...
        delperioder[1].shouldMatch(
            periode = 1.februar(2021) til 28.februar(2021),
            renter = 0.kroner,
            tilbakekrevesBruttoMedRenter = 900.kroner,
            feilutbetaltBeløp = 1500.kroner,
            BeregnetBeløp(
                tilbakekrevesBrutto = 900.kroner,
                skatt = 0.kroner,
                utbetaltYtelsesbeløp = 20000.kroner,
                klassekode = "BATR",
            ),
        ...
        beregning.oppsummer() shouldBe Beregningsresultat(
            listOf(
                Beregningsresultatsperiode(
                    ...
                    andelAvBeløp = 60.prosent,
                    renteprosent = null,
                    manueltSattTilbakekrevingsbeløp = null,
                    tilbakekrevingsbeløpUtenRenter = 2400.kroner,
                    rentebeløp = 0.kroner,
                    tilbakekrevingsbeløp = 2400.kroner,
                    skattebeløp = 0.kroner,
    ...
    fun `ny vilkårsvurdering, deler av beløpet i behold, med reduksjon`() {
        ...
        val beregning = Beregning(
            ...
            foreldetPerioder = emptyList(),
            kravgrunnlag = perioder(
                1.januar(2021) til 31.januar(2021) medTilbakekrevesBeløp 1000.kroner,
                1.februar(2021) til 28.februar(2021) medTilbakekrevesBeløp 3000.kroner,
            ),
            sporing = Sporing(UUID.randomUUID().toString(), UUID.randomUUID().toString()),
        )
        ...
        delperioder[0].shouldMatch(
            periode = 1.januar(2021) til 31.januar(2021),
            renter = 0.kroner,
            tilbakekrevesBruttoMedRenter = 150.kroner,
            feilutbetaltBeløp = 1000.kroner,
            BeregnetBeløp(
                tilbakekrevesBrutto = 150.kroner,
                skatt = 0.kroner,
                utbetaltYtelsesbeløp = 20000.kroner,
                klassekode = "BATR",
            ),
        ...
        delperioder[1].shouldMatch(
            periode = 1.februar(2021) til 28.februar(2021),
            renter = 0.kroner,
            tilbakekrevesBruttoMedRenter = 450.kroner,
            feilutbetaltBeløp = 3000.kroner,
            BeregnetBeløp(
                tilbakekrevesBrutto = 450.kroner,
                skatt = 0.kroner,
                utbetaltYtelsesbeløp = 20000.kroner,
                klassekode = "BATR",
            ),
        ...
        beregning.oppsummer() shouldBe Beregningsresultat(
            listOf(
                Beregningsresultatsperiode(
                    ...
                    renteprosent = null,
                    manueltSattTilbakekrevingsbeløp = null,
                    tilbakekrevingsbeløpUtenRenter = 600.kroner,
                    rentebeløp = 0.kroner,
                    tilbakekrevingsbeløp = 600.kroner,
                    skattebeløp = 0.kroner,
