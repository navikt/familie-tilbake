...
enum class UtenforScope(val tittel: String, val feilmelding: String) {
    ...
    KravgrunnlagAnnullert(
        tittel = "Kravgrunnlaget er annullert",
        feilmelding = "Tilbakekrevingen kan ikke behandles videre fordi kravgrunnlaget kan være annullert i økonomisystemet.",
    ),
    KravgrunnlagSperret(
        tittel = "Kravgrunnlaget er sperret",
        feilmelding = "Tilbakekrevingen kan ikke behandles videre fordi kravgrunnlaget kan være sperret i økonomisystemet.",
    ),
