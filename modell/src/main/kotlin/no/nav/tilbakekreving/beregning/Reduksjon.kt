...
sealed interface Reduksjon {
    ...
    class Prosentdel(override val andel: BigDecimal) : Reduksjon {
        override fun beregn(kravgrunnlagBeløp: BigDecimal, antallPerioderForVilkårsvurdering: Int): BigDecimal {
    ...
    class FullstendigRefusjon : Reduksjon {
        ...
        override fun beregn(kravgrunnlagBeløp: BigDecimal, antallPerioderForVilkårsvurdering: Int): BigDecimal = kravgrunnlagBeløp
    }

    class IngenTilbakekreving : Reduksjon {
        override val andel: BigDecimal? = BigDecimal.ZERO

        override fun beregn(kravgrunnlagBeløp: BigDecimal, antallPerioderForVilkårsvurdering: Int): BigDecimal = BigDecimal.ZERO
    }
}
