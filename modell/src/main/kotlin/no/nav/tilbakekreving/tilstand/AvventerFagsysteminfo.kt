...
object AvventerFagsysteminfo : Tilstand {
    ...
    override fun behandlingsstatus(behandling: Behandling): Behandlingsstatus = Behandlingsstatus.OPPRETTET
    ...
    override fun håndter(
        ...
        tilbakekreving.opprettBehandling(eksternBehandling, Behandler.Vedtaksløsning, fagsysteminfo.behandlendeEnhet)
