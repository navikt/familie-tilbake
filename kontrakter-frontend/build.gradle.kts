...
subprojects {
    ...
    tasks.withType<GenerateTask> {
        ...
        remoteInputSpec = "https://raw.githubusercontent.com/navikt/tilbakekreving-kontrakter/bd6aeaba16cbc333afed6c246140794919dd85e8/tsp-output/schema/openapi.yaml"
