...
subprojects {
    ...
    tasks.withType<GenerateTask> {
        remoteInputSpec = "https://raw.githubusercontent.com/navikt/tilbakekreving-kontrakter/251213da44fd000946400ce7e7641291aeab7939/tsp-output/schema/openapi.yaml"
