...
subprojects {
    ...
    tasks.withType<GenerateTask> {
        remoteInputSpec = "https://raw.githubusercontent.com/navikt/tilbakekreving-kontrakter/4e723cee960874912e567b083b29231790edfd3d/tsp-output/schema/openapi.yaml"
