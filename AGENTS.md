...
- Les, skriv og kjør kun kommandoer mot filer under arbeidsmappen (prosjektmappen). Forsøk aldri å nå filer utenfor prosjektet (f.eks. `/home/runner`, `/tmp` eller lignende) – bruk kun stier relative til arbeidsmappen.
